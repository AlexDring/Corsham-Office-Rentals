      ...
      <div className="mx-auto">
        <div className="flex flex-wrap bg-white lg:px-12 px-6 mx-auto">
          <div className="w-full md:w-1/2 bg-gray-100 lg:p-12 p-8 rounded-l-lg">
            ...
            <a
              className="text-red-500 font-semibold md:text-xl"
              href="tel:01225 891825"
            >
              01225 891825
            </a>
            <h2 className="font-semibold text-gray-900 text-xs mt-4">EMAIL</h2>
            <a
              className="text-red-500 font-semibold md:text-xl break-words"
              href="mailto:francesround@hotmail.co.uk?subject=Corsham%20Office%20Rental%20Enquiry"
            >
