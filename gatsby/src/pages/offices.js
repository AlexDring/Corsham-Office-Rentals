    ...
    <>
      <section className="bg-gray-100">
        <div className="container mx-auto py-12">
          <div className="mt-4 max-w-2xl lg:mx-auto text-center">
            ...
            <p className="text-gray-500 text-lg pt-2">
              ...
              or call{' '}
              <a className="text-red-500 font-semibold" href="tel:01225 891825">
                01225 891825
              </a>
            </p>
          </div>

          <p className="max-w-screen-md mx-4 sm:mx-auto bg-white p-8 mt-8 prose rounded-lg">
